...
namespace BiometricFingerprintApp
{
    ...
    */
    public partial class Verifyfinger : CaptureForm
    {
        public Verifyfinger(DPFP.Template template)
        {
            Template = template;
            ShowDialog();
        }
        ...
        protected override void Process(DPFP.Sample Sample)
        {
            ...
            if (features != null)
            {
                ...
                //  System.Windows.Forms.MessageBox.Show("The fingerprint was VERIFIED");
                else
